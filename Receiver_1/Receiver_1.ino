...
void loop() {
  ...
  if (radio.available()) {
    ...
    int Red_Val = (text[0]-48)*100+(text[1]-48)*10+(text[2]-48);
    int Green_Val = (text[3]-48)*100+(text[4]-48)*10+(text[5]-48);
    int Blue_Val = (text[6]-48)*100+(text[7]-48)*10+(text[8]-48);
    ...
    //if (Green_Val>90 && Green_Val < 100 ) {   theaterChase(strip.Color(0,   Green_Val,   0), 10);      }
    //if (Blue_Val>100 && Blue_Val < 110 ) {   theaterChase(strip.Color(0,   0,   Blue_Val), 10);      }
    int min_ = 200;
    int max_ = 210;
